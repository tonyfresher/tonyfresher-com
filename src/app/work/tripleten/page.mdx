...
It was also a big technical challenge. The first version for VS Code took three months to build, but the gradual rollout and support for more tools took another year.
