...
function DropdownMenuItem({
    ...
    return (
        <DropdownMenuPrimitive.Item
            ...
            className={cn(
                "focus:bg-accent focus:text-accent-foreground data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:bg-destructive/10 dark:data-[variant=destructive]:focus:bg-destructive/20 data-[variant=destructive]:focus:text-destructive data-[variant=destructive]:*:[svg]:!text-destructive relative flex cursor-default items-center gap-2 rounded-sm px-3 py-2 outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[inset]:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
                className
            )}
            {...props}
        />
...
function DropdownMenuRadioItem({
    ...
    return (
        ...
        >
            <span className="pointer-events-none absolute left-2 flex size-3.5 items-center justify-center">
                <DropdownMenuPrimitive.ItemIndicator>
                    <IconCircleFilled className="size-2 fill-current" stroke={1.75} />
                </DropdownMenuPrimitive.ItemIndicator>
            </span>
            {children}
        </DropdownMenuPrimitive.RadioItem>
...
function DropdownMenuLabel({
    ...
    return (
        <DropdownMenuPrimitive.Label
            ...
            data-inset={inset}
            className={cn(
                'text-muted-foreground px-3 pt-2.5 pb-1.5 text-xs tracking-wide uppercase data-[inset]:pl-8',
                className
            )}
            {...props}
        />
